...
<head>
   ...
   <!-- <link href="{{ asset('css/style.css') }}" type="text/css" rel="stylesheet"> -->
    <link href="{{ asset('css/landing.css') }}" type="text/css" rel="stylesheet">
    <!-- Bootstrap CSS -->
...
<script src="https://rawgit.com/sitepoint-editors/jsqrcode/master/src/align_packed.js"></script>
<script src="https://rawgit.com/sitepoint-editors/jsqrcode/master/src/datablock_packed.js"></script>
